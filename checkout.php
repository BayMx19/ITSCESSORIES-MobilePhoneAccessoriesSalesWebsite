...
<html>
<head>
<title>ITSCESSORIES - Checkout</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="ITSCESSORIES" />
	...
	<div class="logo_products">
		...
		<!-- <div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+62) 82191927762</li>
				</ul>
			</div> -->
			<div class="w3ls_logo_products_left1">
				<h1><a href="index.php">ITSCESSORIES</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di ITSCESSORIES</span></h1>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>ITSCESSORIES, Surabaya.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:isaaimuh24@gmail.com">isaaimuh24@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>(+62) 82191927762</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 ITSCESSORIES. All rights reserved</p>
			</div>
		</div>
	...
	<div class="footer-botm">
			<div class="container">
				...
				<ul>
						<li><a href="https://www.instagram.com/_isaim/" class="w3_agile_instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
						<li><a href="https://www.facebook.com/isaiman" class="w3_agile_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
					</ul>
				</div>
