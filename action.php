			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>Idr.$pro_price.00/-
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>Add To Cart</button>
								</div>
							</div>
						</div>	
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/itscessories/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/itscessories/cancel.php"/>
